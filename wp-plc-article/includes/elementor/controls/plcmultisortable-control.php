...
namespace OnePlace\Elementor\Controls;

class WPPLC_Multisortable_Control extends \Elementor\Base_Data_Control {
    ...
    public function enqueue() {
        ...
        wp_register_script( 'plc-multiselect-order', WPPLC_ARTICLE_PUB_DIR.'/assets/js/plc-multiselect-order.js', [ 'jquery' ], '1.0.0' );
        wp_enqueue_script( 'plc-multiselect-order' );
    }
